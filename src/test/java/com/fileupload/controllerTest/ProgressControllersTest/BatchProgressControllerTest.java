...
import com.fileupload.controller.ProgressControllers.BatchProgressController;
...
class BatchProgressControllerTest {
    ...
    void testCalculateBatchwiseProgressFound() {
        ...
        ResponseEntity<?> response = batchProgressController.calculateBatchwiseProgress();
